...
var nextTick = () => __async(null, null, function* () {
});
...
function buildWrappedFallback(contract) {
  ...
  const method = (overrides) => __async(null, null, function* () {
...
function buildWrappedMethod(contract, key) {
  ...
  const method = (...args) => __async(null, null, function* () {
    const fragment = getFragment(...args);
...
function getSub(contract, operation, event) {
  return __async(this, null, function* () {
    ...
    if (!sub) {
      ...
      const stop = () => __async(null, null, function* () {
...
*/
//# sourceMappingURL=chunk-QWNZ7TY4.js.map
